...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/joseph/Desktop/jobber/node-module/@prisma-clients/jobber-auth",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../../../node-module/@prisma-clients/jobber-auth\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"AUTH_DATABASE_URL\")\n}\n\nmodel User {\n  id       Int    @id @default(autoincrement())\n  email    String @unique\n  password String\n}\n",
  "inlineSchemaHash": "088e951fce3614db28edbbeb04c43682fc3ff5f306c4c65e3d6cf7772f338ab8",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "../../node-module/@prisma-clients/jobber-auth",
    "../node-module/@prisma-clients/jobber-auth",
  ]
...
path.join(process.cwd(), "../../node-module/@prisma-clients/jobber-auth/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../../node-module/@prisma-clients/jobber-auth/schema.prisma")
